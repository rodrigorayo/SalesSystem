    ...
    return (
        <div className="bg-white rounded-[40px] p-8 shadow-sm border border-gray-100 mt-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 className="text-2xl font-black text-gray-900">Constructor de Planes</h3>
                    <p className="text-gray-500 font-medium">Diseña planes atómicos y calcula precios recomendados</p>
                </div>
            </div>
            ...
            {/* Listado de Planes Personalizados */}
            {customPlans.length > 0 && (
                <div className="mt-10 border-t border-gray-100 pt-8">
                    <h4 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-wider">Tus Planes Personalizados</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        {customPlans.map(plan => (
                            <div key={plan.id} className="border border-gray-200 rounded-2xl p-4 flex flex-col justify-between hover:border-gray-300 transition-colors bg-gray-50">
                                <div>
